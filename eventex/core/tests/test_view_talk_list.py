...
class TalkListGetEmpyt(TestCase):
    def test_get_empty(self):
        response = self.client.get(r('talk_list'))

        self.assertContains(response, 'Ainda não existem plaestras de manhã.')
        self.assertContains(response, 'Ainda não existem plaestras de tarde.')
