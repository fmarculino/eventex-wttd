...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Fernando Marculino', email.body)
        self.assertIn('55544433322', email.body)
        self.assertIn('fernandomarculino@gmail.com', email.body)
        self.assertIn('94-99189-4670', email.body)
